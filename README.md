...
secrets & variables** (repo and environment scope), the **Sponsor button**
(`.github/FUNDING.yml`), webhooks with delivery history, and deep links to the
settings GitHub keeps browser-only — without leaving the app. **Manage files** git
